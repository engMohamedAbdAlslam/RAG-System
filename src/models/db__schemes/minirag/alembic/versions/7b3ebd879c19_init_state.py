...
Revision ID: 7b3ebd879c19
Revises: 
Create Date: 2026-01-21 19:49:18.459648
...
def upgrade() -> None:
    ...
    sa.Column('poject_uuid', sa.UUID(), nullable=False),
    ...
    sa.UniqueConstraint('poject_uuid')
    )
